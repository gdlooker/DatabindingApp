package com.example.dell.databindingapp.base.adapter
...
import com.example.dell.databindingapp.animation.*
import com.example.dell.databindingapp.listener.*
import com.example.dell.databindingapp.module.*
import com.example.dell.databindingapp.util.getItemView
import com.example.dell.databindingapp.viewholder.BaseViewHolder
...
@JvmOverloads constructor(
     ...
     * @param reset Boolean 是否重置空布局
     */
    fun setEmptyView(emptyView: View, reset: Boolean = false) {
        if(mEmptyView != null && !reset) {
            return
        }
    ...
    fun setEmptyView(layoutResId: Int, reset: Boolean = false) {
        if(mEmptyView != null && !reset) {
            return
        }
